	...
	return (
		<div className="p-10 bg-gray-300">
			<div className="container w-10/12 p-6 mx-auto">
				<div className="pb-4">
					<h1 className="py-4 text-2xl font-extrabold leading-tight text-center sm:text-4xl lin sm:leading-none">Past
					Organizations</h1>
					<p className="text-xs text-center sm:leading-none">Where I have added value</p>
				</div>
