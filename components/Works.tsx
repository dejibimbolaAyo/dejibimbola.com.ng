      ...
      <div className="container w-10/12 p-10 mx-auto">
        ...
        <div className="flex overflow-x-scroll sm:justify-center md:overflow-hidden">
          <div className="flex-col flex-shrink-0 m-4 transition duration-500 ease-in-out shadow-lg hover:shadow-xl">
            <div>
              <ProgressiveImage
                originalImageSrc="./assets/nexstar.png"
                alt="nexstar"
          ...
          <div className="flex-col flex-shrink-0 m-4 transition duration-500 ease-in-out shadow-lg hover:shadow-xl">
            <div>
              <ProgressiveImage
                originalImageSrc="./assets/jamii_web_mobile.png"
                alt="jamii"
                className="w-56 h-auto"
              />
            </div>
          ...
          <div className="flex-col flex-shrink-0 m-4 transition duration-500 ease-in-out shadow-lg hover:shadow-xl">
            <div>
              <ProgressiveImage
                originalImageSrc="./assets/search_service.png"
                alt="sonic-search"
                className="w-56 h-auto"
              />
            </div>
          ...
          <div className="flex-col flex-shrink-0 m-4 transition duration-500 ease-in-out shadow-lg hover:shadow-xl">
            <div>
              <ProgressiveImage
                originalImageSrc="./assets/ussd.png"
                alt=""
                className="w-56 h-auto"
              />
            </div>
