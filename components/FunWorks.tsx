		...
		<div className="container w-10/12 p-10 mx-auto">
			...
			<div className="flex pt-8 pb-12 overflow-x-scroll sm:justify-center md:overflow-hidden">
				<div className="flex-col flex-shrink-0 m-4 transition duration-300 ease-in-out shadow-lg hover:shadow-xl">
					<div>
						<Image src="./assets/1.png" alt="" className="w-56 h-auto" />
					</div>
				</div>
				<div className="flex-col flex-shrink-0 m-4 transition duration-300 ease-in-out shadow-lg hover:shadow-xl">
					<div>
						<Image src="./assets/2.png" alt="" className="w-56 h-auto" />
					</div>
				</div>
				<div className="flex-col flex-shrink-0 m-4 transition duration-300 ease-in-out shadow-lg hover:shadow-xl">
					<div>
						<Image src="./assets/3.png" alt="" className="w-56 h-auto" />
					</div>
				</div>
				<div className="flex-col flex-shrink-0 m-4 transition duration-300 ease-in-out shadow-lg hover:shadow-xl">
					<div>
						<Image src="./assets/4.png" alt="" className="w-56 h-auto" />
					</div>
				</div>
			</div>
