...
export default function FunWorks({}: Props): ReactElement {
  return (
    <div className="container w-10/12 p-10 mx-auto">
      <h1 className="py-4 text-2xl font-extrabold leading-tight text-center sm:text-4xl md:leading-none">
        Fun Stuff
      </h1>
