					...
					<div className="p-4 sm:w-2/4">
						<div className="flex justify-around text-white">
							<div>
								...
								<ul>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">Blog</li>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">Portfolio</li>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">Contact</li>
								</ul>
							</div>
							<div>
								<h2 className="mb-2 text-2xl">Links</h2>
								<ul>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">Github</li>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">LinkedIn</li>
								</ul>
							</div>
						</div>
					</div>
