			...
			<div className="container flex-col justify-center w-11/12">
				<div className="sm:flex">
					<div className="relative hidden -ml-64 opacity-10 sm:h-auto sm:w-full sm:block">
						<Image className="" src="./assets/dejibimbola_lg.png" alt="" />
					</div>
						...
						<div className="flex justify-around text-white">
							<div>
								...
								<ul>
									...
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">
										<Link target="_blank" rel="noreferrer" href="https://blog.dejibimbola.com.ng">Blog</Link>
									</li>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">
							...
							<div>
								...
								<ul>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">
										<Link target="_blank" rel="noreferrer" href="https://github.com/dejibimbolaAyo">GitHub</Link>
									</li>
									<li className="py-1 text-xs transition duration-300 ease-in-out hover:text-yellow-600">
										<Link target="_blank" rel="noreferrer" href="https://linkedin.com/in/dejibimbola">LinkedIn</Link>
									</li>
								</ul>
							</div>
						</div>
				...
				<div className="flex-col items-center text-center sm:flex sm:justify-between">
					<div className="flex justify-center p-4">
						<div className="mx-2">
							<a target="_blank" rel="noreferrer" href="https://github.com/dejibimbolaAyo">
						...
						<div className="mx-2">
							<a target="_blank" rel="noreferrer" href="https://linkedin.com/in/dejibimbola">
								<svg width="16" height="16" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
